...
public class products extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View prods= inflater.inflate(R.layout.fragment_products, container, false);

        pd=new ProgressDialog(getContext());
        pd.setMessage("Loading");
        mycommand=new Mycommand(getContext());

        rvproducts=(RecyclerView)prods.findViewById(R.id.rvprod);
        tvcattt=(TextView)prods.findViewById(R.id.catprodd);
        Bundle bundle = getArguments();
        if (bundle != null) {
            category = bundle.getString("category");
        }
        tvcattt.setText(category);
    ...
    private  void loadproducts(){
        String url="http://quickstore.mabnets.com/android/products.php";
